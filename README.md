...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `alvaroblazquez4567` with the `ORG` of your provider.
   - replace all instances of the `github.com/alvaroblazquez4567/pulumi-dynatrace` repository with the `REPOSITORY` location
...
- binary: pulumi-resource-dynatrace
  ...
  ignore: []
  ldflags:
  - -X github.com/alvaroblazquez4567/pulumi-dynatrace/provider/pkg/version.Version={{.Tag}}
