...
namespace Lbrlabs.PulumiPackage.Dynatrace.Outputs
{
    ...
    [OutputType]
    public sealed class DiskSpecificAnomaliesV2DiskLowInodesDetectionCustomThresholds
    {
        /// <summary>
        ...
        [OutputConstructor]
        private DiskSpecificAnomaliesV2DiskLowInodesDetectionCustomThresholds(int freeInodesPercentage)
        {
