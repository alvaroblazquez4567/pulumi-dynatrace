...
{
    [DynatraceResourceType("dynatrace:index/kubernetes:Kubernetes")]
    public partial class Kubernetes : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("clusterIdEnabled")]
        public Output<bool> ClusterIdEnabled { get; private set; } = null!;
        ...
        /// </summary>
        [Output("hostnameVerificationEnabled")]
        public Output<bool?> HostnameVerificationEnabled { get; private set; } = null!;
        ...
        public Kubernetes(string name, KubernetesArgs args, CustomResourceOptions? options = null)
            : base("dynatrace:index/kubernetes:Kubernetes", name, args ?? new KubernetesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Kubernetes(string name, Input<string> id, KubernetesState? state = null, CustomResourceOptions? options = null)
            : base("dynatrace:index/kubernetes:Kubernetes", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class KubernetesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// For more information on local Kubernetes API monitoring, see the [documentation](https://dt-url.net/6q62uep).
        /// </summary>
        [Input("clusterIdEnabled", required: true)]
        public Input<bool> ClusterIdEnabled { get; set; } = null!;
        ...
        /// Verify hostname in certificate against Kubernetes API URL
        /// </summary>
        [Input("hostnameVerificationEnabled")]
        public Input<bool>? HostnameVerificationEnabled { get; set; }
    ...
    public sealed class KubernetesState : global::Pulumi.ResourceArgs
    {
        ...
        /// For more information on local Kubernetes API monitoring, see the [documentation](https://dt-url.net/6q62uep).
        /// </summary>
        [Input("clusterIdEnabled")]
        public Input<bool>? ClusterIdEnabled { get; set; }
