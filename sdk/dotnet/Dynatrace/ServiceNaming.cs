...
{
    [DynatraceResourceType("dynatrace:index/serviceNaming:ServiceNaming")]
    public partial class ServiceNaming : global::Pulumi.CustomResource
    {
        /// <summary>
        /// A list of matching conditions of the rule. The rule applies only if **all** conditions are fulfilled
        /// </summary>
        [Output("conditions")]
        public Output<ImmutableArray<Outputs.ServiceNamingCondition>> Conditions { get; private set; } = null!;
        ...
        public ServiceNaming(string name, ServiceNamingArgs args, CustomResourceOptions? options = null)
            : base("dynatrace:index/serviceNaming:ServiceNaming", name, args ?? new ServiceNamingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceNaming(string name, Input<string> id, ServiceNamingState? state = null, CustomResourceOptions? options = null)
            : base("dynatrace:index/serviceNaming:ServiceNaming", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServiceNaming Get(string name, Input<string> id, ServiceNamingState? state = null, CustomResourceOptions? options = null)
        {
            return new ServiceNaming(name, id, state, options);
        }
    }

    public sealed class ServiceNamingArgs : global::Pulumi.ResourceArgs
    {
        [Input("conditions")]
        private InputList<Inputs.ServiceNamingConditionArgs>? _conditions;

        /// <summary>
        /// A list of matching conditions of the rule. The rule applies only if **all** conditions are fulfilled
        /// </summary>
        public InputList<Inputs.ServiceNamingConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.ServiceNamingConditionArgs>());
        ...
        public ServiceNamingArgs()
        {
        }
        public static new ServiceNamingArgs Empty => new ServiceNamingArgs();
    }

    public sealed class ServiceNamingState : global::Pulumi.ResourceArgs
    {
        [Input("conditions")]
        private InputList<Inputs.ServiceNamingConditionGetArgs>? _conditions;

        /// <summary>
        /// A list of matching conditions of the rule. The rule applies only if **all** conditions are fulfilled
        /// </summary>
        public InputList<Inputs.ServiceNamingConditionGetArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.ServiceNamingConditionGetArgs>());
            set => _conditions = value;
        }
        ...
        public ServiceNamingState()
        {
        }
        public static new ServiceNamingState Empty => new ServiceNamingState();
    }
}
