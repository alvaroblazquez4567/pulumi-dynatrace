...
namespace Lbrlabs.PulumiPackage.Dynatrace.Inputs
{
    ...
    public sealed class HttpMonitorScriptScriptRequestGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Authentication options for this request
        /// </summary>
        [Input("authentication")]
        public Input<Inputs.HttpMonitorScriptScriptRequestAuthenticationGetArgs>? Authentication { get; set; }
        ...
        /// </summary>
        [Input("configuration")]
        public Input<Inputs.HttpMonitorScriptScriptRequestConfigurationGetArgs>? Configuration { get; set; }
        ...
        /// </summary>
        [Input("validation")]
        public Input<Inputs.HttpMonitorScriptScriptRequestValidationGetArgs>? Validation { get; set; }

        public HttpMonitorScriptScriptRequestGetArgs()
        {
        }
        public static new HttpMonitorScriptScriptRequestGetArgs Empty => new HttpMonitorScriptScriptRequestGetArgs();
    }
}
