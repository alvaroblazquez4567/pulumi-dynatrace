...
namespace Lbrlabs.PulumiPackage.Dynatrace.Inputs
{
    ...
    public sealed class HttpMonitorScriptScriptRequestArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Authentication options for this request
        /// </summary>
        [Input("authentication")]
        public Input<Inputs.HttpMonitorScriptScriptRequestAuthenticationArgs>? Authentication { get; set; }
        ...
        /// </summary>
        [Input("configuration")]
        public Input<Inputs.HttpMonitorScriptScriptRequestConfigurationArgs>? Configuration { get; set; }
        ...
        /// </summary>
        [Input("validation")]
        public Input<Inputs.HttpMonitorScriptScriptRequestValidationArgs>? Validation { get; set; }

        public HttpMonitorScriptScriptRequestArgs()
        {
        }
        public static new HttpMonitorScriptScriptRequestArgs Empty => new HttpMonitorScriptScriptRequestArgs();
    }
}
