...
namespace Lbrlabs.PulumiPackage.Dynatrace.Inputs
{
    ...
    public sealed class AutomationWorkflowTasksTaskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("position")]
        public Input<Inputs.AutomationWorkflowTasksTaskPositionArgs>? Position { get; set; }

        /// <summary>
        /// Configure whether to automatically rerun the task on failure. If not specified no retries will be attempted
        /// </summary>
        [Input("retry")]
        public Input<Inputs.AutomationWorkflowTasksTaskRetryArgs>? Retry { get; set; }
        ...
        public AutomationWorkflowTasksTaskArgs()
        {
        }
        public static new AutomationWorkflowTasksTaskArgs Empty => new AutomationWorkflowTasksTaskArgs();
    }
}
