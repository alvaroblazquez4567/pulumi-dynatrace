...
namespace Lbrlabs.PulumiPackage.Dynatrace.Inputs
{
    ...
    public sealed class WebApplicationUserActionNamingSettingsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// User action naming rules for custom actions
        /// </summary>
        [Input("customActionNamingRules")]
        public Input<Inputs.WebApplicationUserActionNamingSettingsCustomActionNamingRulesGetArgs>? CustomActionNamingRules { get; set; }
        ...
        public Input<Inputs.WebApplicationUserActionNamingSettingsLoadActionNamingRulesGetArgs>? LoadActionNamingRules { get; set; }

        /// <summary>
        /// User action placeholders
        /// </summary>
        [Input("placeholders")]
        public Input<Inputs.WebApplicationUserActionNamingSettingsPlaceholdersGetArgs>? Placeholders { get; set; }
        ...
        public Input<Inputs.WebApplicationUserActionNamingSettingsXhrActionNamingRulesGetArgs>? XhrActionNamingRules { get; set; }

        public WebApplicationUserActionNamingSettingsGetArgs()
        {
        }
        public static new WebApplicationUserActionNamingSettingsGetArgs Empty => new WebApplicationUserActionNamingSettingsGetArgs();
    }
}
