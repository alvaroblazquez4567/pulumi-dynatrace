...
{
    [DynatraceResourceType("dynatrace:index/hostNaming:HostNaming")]
    public partial class HostNaming : global::Pulumi.CustomResource
    {
        /// <summary>
        /// A list of matching conditions of the rule. The rule applies only if **all** conditions are fulfilled
        /// </summary>
        [Output("conditions")]
        public Output<ImmutableArray<Outputs.HostNamingCondition>> Conditions { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a HostNaming resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public HostNaming(string name, HostNamingArgs args, CustomResourceOptions? options = null)
            : base("dynatrace:index/hostNaming:HostNaming", name, args ?? new HostNamingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HostNaming(string name, Input<string> id, HostNamingState? state = null, CustomResourceOptions? options = null)
            : base("dynatrace:index/hostNaming:HostNaming", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing HostNaming resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static HostNaming Get(string name, Input<string> id, HostNamingState? state = null, CustomResourceOptions? options = null)
        {
            return new HostNaming(name, id, state, options);
        }
    }

    public sealed class HostNamingArgs : global::Pulumi.ResourceArgs
    {
        [Input("conditions")]
        private InputList<Inputs.HostNamingConditionArgs>? _conditions;

        /// <summary>
        /// A list of matching conditions of the rule. The rule applies only if **all** conditions are fulfilled
        /// </summary>
        public InputList<Inputs.HostNamingConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.HostNamingConditionArgs>());
        ...
        public HostNamingArgs()
        {
        }
        public static new HostNamingArgs Empty => new HostNamingArgs();
    }

    public sealed class HostNamingState : global::Pulumi.ResourceArgs
    {
        [Input("conditions")]
        private InputList<Inputs.HostNamingConditionGetArgs>? _conditions;

        /// <summary>
        /// A list of matching conditions of the rule. The rule applies only if **all** conditions are fulfilled
        /// </summary>
        public InputList<Inputs.HostNamingConditionGetArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.HostNamingConditionGetArgs>());
            set => _conditions = value;
        }
        ...
        public HostNamingState()
        {
        }
        public static new HostNamingState Empty => new HostNamingState();
    }
}
