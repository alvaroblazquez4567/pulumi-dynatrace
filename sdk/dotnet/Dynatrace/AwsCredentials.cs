...
namespace Lbrlabs.PulumiPackage.Dynatrace
{
    ...
    public sealed class AwsCredentialsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// supporting services to be monitored
        /// </summary>
        [Obsolete(@"Managing supporting services directly within AWS Credentials has been deprecated within the REST API. This attribute just exists for backwards compatibility. It no longer has an effect. For managing services use the resource `dynatrace_aws_service`")]
