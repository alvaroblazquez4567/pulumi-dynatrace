...
class UserActionMetricsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['UserActionMetricsValueArgs'] value: no documentation available
...
class UserActionMetrics(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] metric_key: Metric key
        :param pulumi.Input[pulumi.InputType['UserActionMetricsValueArgs']] value: no documentation available
        """
        ...
    @overload
    def __init__(__self__,
