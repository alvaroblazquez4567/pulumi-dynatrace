...
class UrlBasedSamplingArgs:
    def __init__(__self__, *,
                 ...
                 query_parameters: pulumi.Input['UrlBasedSamplingQueryParametersArgs'],
    ...
    def query_parameters(self) -> pulumi.Input['UrlBasedSamplingQueryParametersArgs']:
        """
    ...
    def query_parameters(self, value: pulumi.Input['UrlBasedSamplingQueryParametersArgs']):
...
class UrlBasedSampling(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if query_parameters is None and not opts.urn:
                raise TypeError("Missing required property 'query_parameters'")
    ...
    @property
    @pulumi.getter(name="queryParameters")
    def query_parameters(self) -> pulumi.Output['outputs.UrlBasedSamplingQueryParameters']:
        """
        Add URL parameters in any order. **All** specified parameters must be present in the query of an URL to get a match.
        """
        return pulumi.get(self, "query_parameters")
