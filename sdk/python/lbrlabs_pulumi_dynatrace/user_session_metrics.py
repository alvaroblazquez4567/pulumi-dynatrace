...
class UserSessionMetricsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['UserSessionMetricsValueArgs'] value: no documentation available
...
class UserSessionMetrics(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] metric_key: Metric key
        :param pulumi.Input[pulumi.InputType['UserSessionMetricsValueArgs']] value: no documentation available
        """
        ...
    @overload
    def __init__(__self__,
