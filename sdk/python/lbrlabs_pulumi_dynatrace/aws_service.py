...
class AwsServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AwsServiceMetricArgs']]] metrics: A list of metrics to be monitored for this service. Depending on the service Dynatrace insists on a set of recommended
...
class AwsService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] credentials_id: the ID of the azure credentials this supported service belongs to
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['AwsServiceMetricArgs']]]] metrics: A list of metrics to be monitored for this service. Depending on the service Dynatrace insists on a set of recommended
               metrics to be configured for that service. If any of these recommended metrics is missing here, the Terraform Provider
               will automatically add them during `terraform apply`. This usually results in a non-empty plan, until all of the
               recommended metrics are present within your configuration. For services considered `built-in` by Dynatrace any metrics
               specified here will be ignored - Dynatrace enforces a fixed set of metrics for these services.
