...
class AutomationWorkflowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: A description for this task
        ...
        :param pulumi.Input['AutomationWorkflowTriggerArgs'] trigger: Detailed configuration about the timing constraints that trigger the execution
        """
...
class AutomationWorkflow(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] title: The title / name of the workflow
        :param pulumi.Input[pulumi.InputType['AutomationWorkflowTriggerArgs']] trigger: Detailed configuration about the timing constraints that trigger the execution
        """
        ...
    @overload
    def __init__(__self__,
