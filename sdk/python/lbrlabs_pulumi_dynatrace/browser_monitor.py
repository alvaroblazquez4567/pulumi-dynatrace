...
class BrowserMonitorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] enabled: Performance threshold is enabled (`true`) or disabled (`false`)
        ...
        :param pulumi.Input[str] name: The name of the cookie. The following cookie names are now allowed: `dtCookie`, `dtLatC`, `dtPC`, `rxVisitor`, `rxlatency`, `rxpc`, `rxsession` and `rxvt`
