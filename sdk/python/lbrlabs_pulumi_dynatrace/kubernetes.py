...
class KubernetesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] label: Field selector name
        ...
        if cloud_application_pipeline_enabled is not None:
            warnings.warn("""This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""", DeprecationWarning)
            pulumi.log.warn("""cloud_application_pipeline_enabled is deprecated: This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""")
        if cloud_application_pipeline_enabled is not None:
        ...
        if event_patterns is not None:
            warnings.warn("""This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""", DeprecationWarning)
            pulumi.log.warn("""event_patterns is deprecated: This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""")
        if event_patterns is not None:
            pulumi.set(__self__, "event_patterns", event_patterns)
        if event_processing_active is not None:
            warnings.warn("""This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""", DeprecationWarning)
            pulumi.log.warn("""event_processing_active is deprecated: This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""")
        if event_processing_active is not None:
            pulumi.set(__self__, "event_processing_active", event_processing_active)
        if filter_events is not None:
            warnings.warn("""This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""", DeprecationWarning)
            pulumi.log.warn("""filter_events is deprecated: This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""")
        if filter_events is not None:
        ...
        if include_all_fdi_events is not None:
            warnings.warn("""This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""", DeprecationWarning)
            pulumi.log.warn("""include_all_fdi_events is deprecated: This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""")
        if include_all_fdi_events is not None:
            pulumi.set(__self__, "include_all_fdi_events", include_all_fdi_events)
        if open_metrics_builtin_enabled is not None:
            warnings.warn("""This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""", DeprecationWarning)
            pulumi.log.warn("""open_metrics_builtin_enabled is deprecated: This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""")
        if open_metrics_builtin_enabled is not None:
        ...
        if open_metrics_pipeline_enabled is not None:
            warnings.warn("""This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""", DeprecationWarning)
            pulumi.log.warn("""open_metrics_pipeline_enabled is deprecated: This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""")
        if open_metrics_pipeline_enabled is not None:
            pulumi.set(__self__, "open_metrics_pipeline_enabled", open_metrics_pipeline_enabled)
        if pvc_monitoring_enabled is not None:
            warnings.warn("""This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""", DeprecationWarning)
            pulumi.log.warn("""pvc_monitoring_enabled is deprecated: This field has been moved to a new schema, please utilize the resource `dynatrace_k8s_monitoring` to configure this field.""")
        if pvc_monitoring_enabled is not None:
