...
class WebApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: The name of the conversion goal. Valid length within 1 and 50 characters.
        ...
        if key_user_actions is not None:
            warnings.warn("""Configuring Key User Actions within `dynatrace_web_application` is discouraged. Use the dedicated resource `dynatrace_key_user_action` instead.""", DeprecationWarning)
            pulumi.log.warn("""key_user_actions is deprecated: Configuring Key User Actions within `dynatrace_web_application` is discouraged. Use the dedicated resource `dynatrace_key_user_action` instead.""")
        if key_user_actions is not None:
