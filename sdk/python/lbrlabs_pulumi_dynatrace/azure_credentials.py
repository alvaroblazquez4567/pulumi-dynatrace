...
class AzureCredentialsArgs:
    def __init__(__self__, *,
        ...
        if supporting_services is not None:
            warnings.warn("""Assigning supported services directly when creating Azure Credentials is deprecated. Use the resource `dynatrace_azure_service` instead.""", DeprecationWarning)
            pulumi.log.warn("""supporting_services is deprecated: Assigning supported services directly when creating Azure Credentials is deprecated. Use the resource `dynatrace_azure_service` instead.""")
        if supporting_services is not None:
