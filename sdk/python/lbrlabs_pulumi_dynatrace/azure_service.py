...
class AzureServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AzureServiceMetricArgs']]] metrics: A list of metrics to be monitored for this service. Depending on the service Dynatrace insists on a set of recommended
        ...
        :param pulumi.Input[str] name: the name of the metric of the supporting service
        :param pulumi.Input[bool] use_recommended_metrics: If `true` Terraform will negotiate with the Dynatrace API about the recommended/enforced metrics to be applied. Any
...
class _AzureServiceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AzureServiceMetricArgs']]] metrics: A list of metrics to be monitored for this service. Depending on the service Dynatrace insists on a set of recommended
               ...
               specified here will be ignored - Dynatrace enforces a fixed set of metrics for these services.
        :param pulumi.Input[str] name: the name of the metric of the supporting service
        :param pulumi.Input[str] required_metrics: Used internally by the Terraform Provider in order to remember the metrics enforced by Dynatrace
        :param pulumi.Input[bool] use_recommended_metrics: If `true` Terraform will negotiate with the Dynatrace API about the recommended/enforced metrics to be applied. Any
               `metric` specified will be therefore ignored.
        """
...
class AzureService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] credentials_id: the ID of the azure credentials this supported service belongs to
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['AzureServiceMetricArgs']]]] metrics: A list of metrics to be monitored for this service. Depending on the service Dynatrace insists on a set of recommended
               metrics to be configured for that service. If any of these recommended metrics is missing here, the Terraform Provider
               will automatically add them during `terraform apply`. This usually results in a non-empty plan, until all of the
               recommended metrics are present within your configuration. For services considered `built-in` by Dynatrace any metrics
               specified here will be ignored - Dynatrace enforces a fixed set of metrics for these services.
