...
class HostMonitoringArgs:
    def __init__(__self__, *,
        ...
        if auto_injection is not None:
            warnings.warn("""This field has been moved to a new schema, please utilize the resource `dynatrace_host_monitoring_advanced` to configure this field.""", DeprecationWarning)
            pulumi.log.warn("""auto_injection is deprecated: This field has been moved to a new schema, please utilize the resource `dynatrace_host_monitoring_advanced` to configure this field.""")
        if auto_injection is not None:
