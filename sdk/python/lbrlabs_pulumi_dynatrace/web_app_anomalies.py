...
class WebAppAnomaliesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['WebAppAnomaliesTrafficDropsArgs'] traffic_drops: Dynatrace learns your typical application traffic over an observation period of one week.
        :param pulumi.Input['WebAppAnomaliesTrafficSpikesArgs'] traffic_spikes: Dynatrace learns your typical application traffic over an observation period of one week.
...
class WebAppAnomalies(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] scope: The scope of this setting (APPLICATION_METHOD, APPLICATION). Omit this property if you want to cover the whole environment.
        :param pulumi.Input[pulumi.InputType['WebAppAnomaliesTrafficDropsArgs']] traffic_drops: Dynatrace learns your typical application traffic over an observation period of one week.
        :param pulumi.Input[pulumi.InputType['WebAppAnomaliesTrafficSpikesArgs']] traffic_spikes: Dynatrace learns your typical application traffic over an observation period of one week.
        """
        ...
    @overload
    def __init__(__self__,
