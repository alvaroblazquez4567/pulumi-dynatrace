...
class HttpMonitorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: The key of the header
        :param pulumi.Input[bool] no_script: No script block - handle requests via `dynatrace_http_monitor_script` resource
