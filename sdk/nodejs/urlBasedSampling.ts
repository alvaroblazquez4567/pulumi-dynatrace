...
export class UrlBasedSampling extends pulumi.CustomResource {
     ...
     */
    public readonly queryParameters!: pulumi.Output<outputs.UrlBasedSamplingQueryParameters>;
    /**
    ...
    constructor(name: string, argsOrState?: UrlBasedSamplingArgs | UrlBasedSamplingState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if ((!args || args.queryParameters === undefined) && !opts.urn) {
                throw new Error("Missing required property 'queryParameters'");
            }
