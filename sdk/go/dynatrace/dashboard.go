...
type Dashboard struct {
	...
	DashboardMetadata DashboardDashboardMetadataPtrOutput `pulumi:"dashboardMetadata"`
	...
	Tiles DashboardTileArrayOutput `pulumi:"tiles"`
...
func GetDashboard(ctx *pulumi.Context,
	...
	var resource Dashboard
	err := ctx.ReadResource("dynatrace:index/dashboard:Dashboard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type dashboardState struct {
	// contains parameters of a dashboard
	DashboardMetadata *DashboardDashboardMetadata `pulumi:"dashboardMetadata"`
	// `metadata` exists for backwards compatibility but shouldn't get specified anymore
	//
	// Deprecated: `metadata` exists for backwards compatibility but shouldn't get specified anymore
	Metadata *DashboardMetadata `pulumi:"metadata"`
	// the tiles this Dashboard consist of
	Tiles []DashboardTile `pulumi:"tiles"`
	// allows for configuring properties that are not explicitly supported by the current version of this provider
...
type DashboardState struct {
	// contains parameters of a dashboard
	DashboardMetadata DashboardDashboardMetadataPtrInput
	// `metadata` exists for backwards compatibility but shouldn't get specified anymore
	//
	// Deprecated: `metadata` exists for backwards compatibility but shouldn't get specified anymore
	Metadata DashboardMetadataPtrInput
	// the tiles this Dashboard consist of
	Tiles DashboardTileArrayInput
	// allows for configuring properties that are not explicitly supported by the current version of this provider
...
// contains parameters of a dashboard
func (o DashboardOutput) DashboardMetadata() DashboardDashboardMetadataPtrOutput {
	return o.ApplyT(func(v *Dashboard) DashboardDashboardMetadataPtrOutput { return v.DashboardMetadata }).(DashboardDashboardMetadataPtrOutput)
}
...
// the tiles this Dashboard consist of
func (o DashboardOutput) Tiles() DashboardTileArrayOutput {
	return o.ApplyT(func(v *Dashboard) DashboardTileArrayOutput { return v.Tiles }).(DashboardTileArrayOutput)
}

// allows for configuring properties that are not explicitly supported by the current version of this provider
func (o DashboardOutput) Unknowns() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Dashboard) pulumi.StringPtrOutput { return v.Unknowns }).(pulumi.StringPtrOutput)
}
