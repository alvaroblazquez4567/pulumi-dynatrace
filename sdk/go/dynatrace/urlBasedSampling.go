...
type UrlBasedSampling struct {
	...
	QueryParameters UrlBasedSamplingQueryParametersOutput `pulumi:"queryParameters"`
...
func NewUrlBasedSampling(ctx *pulumi.Context,
	...
	if args.QueryParameters == nil {
		return nil, errors.New("invalid value for required argument 'QueryParameters'")
	}
...
type UrlBasedSamplingArgs struct {
	...
	PathComparisonType pulumi.StringPtrInput
	// Add URL parameters in any order. **All** specified parameters must be present in the query of an URL to get a match.
	QueryParameters UrlBasedSamplingQueryParametersInput
	// The scope of this setting (PROCESS*GROUP*INSTANCE, PROCESS_GROUP). Omit this property if you want to cover the whole environment.
	Scope pulumi.StringPtrInput
}
...
// Add URL parameters in any order. **All** specified parameters must be present in the query of an URL to get a match.
func (o UrlBasedSamplingOutput) QueryParameters() UrlBasedSamplingQueryParametersOutput {
	return o.ApplyT(func(v *UrlBasedSampling) UrlBasedSamplingQueryParametersOutput { return v.QueryParameters }).(UrlBasedSamplingQueryParametersOutput)
}
